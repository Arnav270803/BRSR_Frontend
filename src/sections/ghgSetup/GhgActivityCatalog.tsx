  ...
  return (
    <section className="rounded-lg border border-white/70 bg-white/50 p-4 shadow-[0_18px_60px_rgba(35,47,38,0.10)] backdrop-blur-2xl sm:p-5 2xl:p-6">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <p className="text-sm font-semibold text-[#426a52]">Activity catalog</p>
          <h2 className="mt-1 text-xl font-semibold text-[#142019]">Choose fields by category</h2>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <span className="w-fit rounded-md border border-[#bdd3c3] bg-[#edf6ef] px-3 py-1.5 text-xs font-semibold text-[#2f6b45]">
      ...
      <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px_180px]">
        <label className="relative">
          ...
          />
          <input
            className="h-11 w-full rounded-md border border-[#d2ded6] bg-white/75 pr-3 pl-10 text-sm text-[#16211b] shadow-sm outline-none transition placeholder:text-[#9aa39d] focus:border-[#678c72] focus:ring-3 focus:ring-[#426a52]/15"
        ...
        <label>
          ...
          <select
            className="h-11 w-full rounded-md border border-[#d2ded6] bg-white/75 px-3 text-sm text-[#16211b] shadow-sm outline-none transition focus:border-[#678c72] focus:ring-3 focus:ring-[#426a52]/15"
      ...
      <div className="mt-4 flex flex-col gap-3 rounded-lg border border-[#d9e2dc] bg-white/45 p-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {categoriesWithActivities.length > 0 ? (
          categoriesWithActivities.map((group) => {
            ...
            return (
              ...
              >
                <div className="flex flex-col gap-3 border-b border-[#d9e2dc] bg-[#f7faf7]/75 p-3 sm:flex-row sm:items-center sm:justify-between">
                  <button
                  ...
                  >
                    <span className="grid size-9 shrink-0 place-items-center rounded-md bg-white/75 text-[#315f42]">
                      <ChevronDown
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {canEdit ? (
                      <button
                        className="inline-flex h-9 items-center justify-center gap-2 rounded-md border border-[#cdd9d1] bg-white/75 px-3 text-xs font-semibold text-[#1d2a22] transition hover:border-[#9fb5a6] hover:bg-white focus:ring-3 focus:ring-[#426a52]/20 focus:outline-none"
    ...
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <h3 className="mt-3 text-base font-semibold text-[#142019]">
            {getActivityLabel(activity)}
          </h3>
        ...
        <button
          ...
          className={`inline-flex h-10 shrink-0 items-center justify-center rounded-md border px-4 text-sm font-semibold transition focus:ring-3 focus:ring-[#426a52]/20 focus:outline-none ${
            isSelected
...
function ActivityMeta({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-md border border-[#e0e8e2] bg-white/55 p-3">
