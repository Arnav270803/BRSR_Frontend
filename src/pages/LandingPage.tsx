...
const frameworkCards = [
  {
    ...
    icon: ShieldCheck,
    tone: "teal",
    copy: "Equip leadership to manage climate risks, protect natural assets and build long-term resilience.",
  },
  {
    letter: "R",
    ...
    icon: Users,
    tone: "teal",
    copy: "Embed social accountability from supply chains to communities into every business decision.",
  },
  {
    letter: "O",
    title: "Opportunity",
    icon: LineChart,
    tone: "gold",
    copy: "Turn ESG into competitive advantage with green finance, new markets and investor trust.",
  },
  {
    letter: "C",
    title: "Compliance",
  ...
  },
  {
    ...
    icon: Leaf,
    tone: "teal",
    copy: "Measure, manage and reduce carbon footprint from energy to emissions to net zero pathways.",
  },
  {
    letter: "S",
  ...
  },
  {
    ...
    icon: Building2,
    tone: "teal",
    copy: "Strengthen board oversight, ESG reporting structures and accountability frameworks.",
  },
];
...
const focusAreas = [
  { title: "Reduce Emissions", copy: "Track and cut carbon footprint", icon: Sprout, color: "text-[#2b8e2e]" },
  { title: "Water Stewardship", copy: "Measure, manage, improve", icon: Droplets, color: "text-[#2478b5]" },
  { title: "Diversity & Inclusion", copy: "Build fair workplaces", icon: Users, color: "text-[#169b83]" },
  { title: "Ethics & Transparency", copy: "Strengthen governance", icon: ShieldCheck, color: "text-[#f2b65c]" },
];

const aboutCards = [
  { label: "Founded", value: "2021 in India", tone: "bg-[#169b83]" },
  { label: "Focus", value: "ESG, Sustainability & Digital Transformation", tone: "bg-[#2478b5]" },
  { label: "Reach", value: "India, APAC & Global", tone: "bg-[#2b8e2e]" },
  { label: "Expertise", value: "25+ years combined leadership experience", tone: "bg-[#1f3f70]" },
];

export function LandingPage() {
  return (
    <main className="min-h-screen bg-[#f6f8fb] text-[#07182e]">
      <HeroSection />
      <FrameworkSection />
      <PlatformSection />
      <AboutSection />
...
function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#00162f] text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_26%,rgba(36,120,181,0.34),transparent_34%),linear-gradient(135deg,#00142c_0%,#021f41_54%,#001226_100%)]" />
      <div className="absolute inset-0 opacity-25 [background-image:linear-gradient(135deg,rgba(255,255,255,0.10)_1px,transparent_1px)] [background-size:34px_34px]" />

      <header className="relative z-10 border-b border-white/10 bg-[#00162f]/72 backdrop-blur-xl">
        <div className="mx-auto flex h-24 max-w-[1480px] items-center justify-between px-5 sm:px-8 lg:px-14">
          ...
          <nav className="hidden items-center gap-9 text-[15px] font-medium text-white/88 lg:flex">
            <a className="inline-flex items-center gap-1.5 transition hover:text-[#f2c86b]" href="#solutions">
              Solutions <ChevronDown size={16} />
            </a>
            <a className="transition hover:text-[#f2c86b]" href="#platform">
              Platform
            </a>
            <a className="transition hover:text-[#f2c86b]" href="#services">
              Services
            </a>
            <a className="inline-flex items-center gap-1.5 transition hover:text-[#f2c86b]" href="#resources">
              Resources <ChevronDown size={16} />
            </a>
            <a className="transition hover:text-[#f2c86b]" href="#about">
              About Us
            </a>
            <a className="transition hover:text-[#f2c86b]" href="#contact">
              Contact
            </a>
          </nav>
          ...
          <div className="hidden items-center gap-3 sm:flex">
            <Link
              className="inline-flex h-12 min-w-28 items-center justify-center rounded-md border border-white/70 px-6 text-sm font-semibold text-white transition hover:bg-white hover:text-[#00162f]"
              to="/login"
            >
              Login
            </Link>
            <Link
              className="inline-flex h-12 min-w-32 items-center justify-center rounded-md bg-[#f2bd56] px-6 text-sm font-bold text-[#07182e] shadow-[0_12px_34px_rgba(242,189,86,0.28)] transition hover:bg-[#ffd06f]"
              to="/login"
            >
              Sign Up
            </Link>
        ...
        {isMenuOpen ? (
          <nav className="grid gap-3 border-t border-white/10 px-5 py-5 text-sm font-semibold text-white/90 sm:px-8 lg:hidden">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              ...
              <Link className="inline-flex h-11 items-center justify-center rounded-md bg-[#f2bd56] font-bold text-[#07182e]" to="/login">
                Sign Up
              </Link>
            </div>
          </nav>
      ...
      <div id="top" className="relative z-10 mx-auto grid max-w-[1480px] items-center gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[0.92fr_1.08fr] lg:px-14 lg:py-20 xl:py-24">
        <div>
          <p className="inline-flex items-center gap-2 rounded-full border border-white/18 bg-white/8 px-4 py-2 text-sm font-semibold text-[#96e5d5] shadow-[0_10px_34px_rgba(0,0,0,0.18)]">
            <Sparkles size={16} />
            BRSR and SEBI aligned ESG platform
          </p>

          <h1 className="mt-7 max-w-3xl text-5xl leading-[1.04] font-extrabold tracking-normal text-white sm:text-6xl lg:text-7xl">
            Turn BRSR compliance into measurable{" "}
            <span className="text-[#54d8bd]">ESG value</span>
          </h1>

          <p className="mt-6 max-w-2xl text-lg leading-8 text-[#d9e7f5]">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              className="inline-flex h-14 items-center justify-center gap-3 rounded-md bg-[#f2bd56] px-7 text-base font-bold text-[#07182e] shadow-[0_18px_44px_rgba(242,189,86,0.28)] transition hover:bg-[#ffd06f]"
              href="#contact"
            >
            ...
            <a
              className="inline-flex h-14 items-center justify-center gap-3 rounded-md border border-white/70 bg-white/6 px-7 text-base font-semibold text-white transition hover:bg-white hover:text-[#00162f]"
              href="#platform"
            >
              <Play size={19} />
              Explore Platform
...
function TrustItem({ icon: Icon, label }: { icon: typeof ShieldCheck; label: string }) {
  return (
    <div className="flex items-center gap-3 border-r border-white/18 last:border-r-0 sm:last:border-r lg:pr-4 lg:last:border-r-0">
      <span className="grid size-10 shrink-0 place-items-center rounded-md border border-[#54d8bd]/40 bg-[#54d8bd]/10 text-[#7ee9d8]">
        <Icon size={20} />
      </span>
      ...
      <div className="absolute top-5 right-5 left-0 rounded-lg border border-white/55 bg-white p-5 text-[#07182e] shadow-[0_30px_90px_rgba(0,0,0,0.34)] lg:left-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-bold">ESG Overview</p>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
          <ScoreRing label="Overall ESG Score" value="78" color="#2478b5" />
          <ScoreRing label="Environmental" value="82" color="#2b8e2e" />
          <ScoreRing label="Social" value="73" color="#f2b65c" />
          <ScoreRing label="Governance" value="79" color="#169b83" />
        </div>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1fr_1.25fr]">
          <div className="rounded-lg border border-[#e1e7ef] bg-white p-4 shadow-sm">
            <p className="font-bold text-[#07182e]">BRSR Compliance</p>
            <div className="mt-4 space-y-3">
              {["General Disclosures", "Management & Process Disclosures", "Principle-wise Performance", "Core Indicators", "Leadership Indicators"].map((item) => (
                <div className="flex items-center gap-2 text-xs font-medium text-[#41516a]" key={item}>
                  <span className="grid size-5 place-items-center rounded-full bg-[#2b8e2e] text-white">
                    <Check size={13} />
                  </span>
                  {item}
                </div>
            ...
            <p className="mt-5 text-xs font-bold text-[#40516a]">5 / 5 Completed</p>
            <div className="mt-2 h-2 rounded-full bg-[#e6edf1]">
              <div className="h-full w-full rounded-full bg-[#2b8e2e]" />
            </div>
          </div>

          <div className="rounded-lg border border-[#e1e7ef] bg-white p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <p className="font-bold text-[#07182e]">Performance Trend</p>
              <div className="flex gap-3 text-[10px] font-semibold text-[#6d7890]">
                ...
                <span className="inline-flex items-center gap-1"><i className="size-2 rounded-sm bg-[#2478b5]" /> FY 23-24</span>
                <span className="inline-flex items-center gap-1"><i className="size-2 rounded-sm bg-[#2b8e2e]" /> FY 24-25</span>
              </div>
            </div>
      ...
      <div className="flex h-36 items-end gap-2">
        {values.map((value, index) => (
          <span
            className={[
              "w-4 rounded-t-sm",
              index === 0 ? "bg-[#b9cddd]" : index === 1 ? "bg-[#2478b5]" : "bg-[#2b8e2e]",
            ].join(" ")}
            key={value + index}
            style={{ height: `${value}%` }}
          />
    ...
    <section id="solutions" className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-14">
        <div className="max-w-3xl">
          <p className="text-sm font-bold tracking-[0.18em] text-[#169b83] uppercase">
  ...
  return (
    <article
      className={[
        ...
        isGold ? "bg-[#f2b65c] text-[#07182e]" : "bg-[#169b83] text-white",
      ].join(" ")}
    >
...
function PlatformSection() {
  return (
    <section id="platform">
      <div className="relative overflow-hidden bg-[#00162f] py-16 text-white sm:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,rgba(22,155,131,0.24),transparent_30%),radial-gradient(circle_at_80%_54%,rgba(36,120,181,0.28),transparent_34%)]" />
        <div className="relative mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-14">
          <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-center">
            <div>
              <p className="text-sm font-bold tracking-[0.18em] text-[#7ee9d8] uppercase">
                Platform
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {workflow.map((item, index) => (
                <article className="rounded-lg border border-white/14 bg-white/[0.07] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.22)] backdrop-blur" key={item.title}>
                  <div className="flex items-center justify-between">
                    <span className="grid size-11 place-items-center rounded-md bg-[#f2bd56] text-[#07182e]">
                      <item.icon size={22} />
                    </span>
          ...
          <div className="mt-12 rounded-lg border border-white/16 bg-white p-5 text-[#07182e] shadow-[0_34px_90px_rgba(0,0,0,0.28)] lg:p-7">
            <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
              <div>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-bold text-[#169b83]">Action Plan</p>
                    <h3 className="mt-1 text-2xl font-extrabold">BRSR readiness dashboard</h3>
                  </div>
                  <span className="rounded-md bg-[#edf7f3] px-3 py-2 text-xs font-bold text-[#169b83]">
                    82% Ready
                  </span>
                </div>
                <div className="mt-6 overflow-hidden rounded-lg border border-[#e1e7ef]">
                  {[
                    ...
                    <div className="grid grid-cols-[1fr_auto_90px] items-center gap-4 border-b border-[#e1e7ef] px-4 py-4 last:border-b-0" key={name}>
                      ...
                      <div>
                        <p className="mb-1 text-right text-xs font-bold text-[#2478b5]">{progress}</p>
                        <div className="h-1.5 rounded-full bg-[#e6edf1]">
                          <div className="h-full rounded-full bg-[#2478b5]" style={{ width: progress }} />
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="mt-6 grid gap-3">
                  {["Evidence quality", "Regulatory confidence", "Board readiness"].map((label, index) => (
                    <div className="flex items-center justify-between text-sm font-semibold" key={label}>
                      <span>{label}</span>
                      <span className="text-[#169b83]">{[92, 86, 78][index]}%</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-14">
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <div className="rounded-lg border border-[#dce3eb] bg-white p-4 shadow-sm sm:flex sm:items-center sm:gap-3">
              <Link className="inline-flex h-11 items-center justify-center rounded-md border border-[#1f3f70] px-5 text-sm font-bold text-[#1f3f70] transition hover:bg-[#edf4fa]" to="/login">
                Login
              </Link>
              <Link className="mt-3 inline-flex h-11 items-center justify-center rounded-md bg-[#f2bd56] px-5 text-sm font-bold text-[#07182e] transition hover:bg-[#ffd06f] sm:mt-0" to="/login">
                Sign Up
              </Link>
            </div>
          </div>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {serviceCards.map((card) => (
              <article className="rounded-lg border border-[#dce3eb] bg-white p-6 shadow-[0_18px_50px_rgba(10,35,70,0.08)] transition hover:-translate-y-1 hover:shadow-[0_26px_70px_rgba(10,35,70,0.13)]" key={card.title}>
                <span className="grid size-12 place-items-center rounded-md bg-[#edf7f3] text-[#169b83]">
                  <card.icon size={24} />
                </span>
                ...
                <a className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-[#2478b5]" href="#contact">
  ...
  return (
    <section id="about" className="bg-white">
      ...
      <div id="contact" className="bg-[#f6f8fb] px-5 py-16 sm:px-8 sm:py-20 lg:px-14">
        <div className="mx-auto grid max-w-[1480px] overflow-hidden rounded-lg bg-[#00162f] text-white shadow-[0_32px_90px_rgba(10,35,70,0.2)] lg:grid-cols-[1fr_420px]">
          <div className="relative p-8 sm:p-10 lg:p-12">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a className="inline-flex h-13 items-center justify-center gap-3 rounded-md bg-[#f2bd56] px-6 text-sm font-bold text-[#07182e] transition hover:bg-[#ffd06f]" href="#contact">
          ...
          <form className="bg-white p-6 text-[#07182e] sm:p-8" onSubmit={(event) => event.preventDefault()}>
            ...
            <div className="mt-5 grid gap-4">
              <label className="grid gap-2 text-sm font-bold text-[#40516a]">
                Name
                <input className="h-12 rounded-md border border-[#dce3eb] px-4 text-[#07182e] outline-none focus:border-[#169b83] focus:ring-3 focus:ring-[#169b83]/15" placeholder="Name" />
              </label>
              <label className="grid gap-2 text-sm font-bold text-[#40516a]">
                Work Email
                <input className="h-12 rounded-md border border-[#dce3eb] px-4 text-[#07182e] outline-none focus:border-[#169b83] focus:ring-3 focus:ring-[#169b83]/15" placeholder="Work Email" />
              </label>
              <label className="grid gap-2 text-sm font-bold text-[#40516a]">
                Company
                <input className="h-12 rounded-md border border-[#dce3eb] px-4 text-[#07182e] outline-none focus:border-[#169b83] focus:ring-3 focus:ring-[#169b83]/15" placeholder="Company" />
              </label>
              <button className="mt-2 inline-flex h-12 items-center justify-center rounded-md bg-[#169b83] px-5 text-sm font-bold text-white transition hover:bg-[#11836f]" type="submit">
                Submit
              </button>
            </div>
          </form>
...
function Footer() {
  return (
    <footer className="bg-[#00162f] px-5 py-10 text-white sm:px-8 lg:px-14">
      <div className="mx-auto max-w-[1480px]">
        <div className="grid gap-9 border-b border-white/14 pb-8 lg:grid-cols-[1.15fr_0.85fr_1fr] lg:items-start">
          ...
          <nav className="grid grid-cols-2 gap-3 text-sm font-semibold text-[#d9e7f5] sm:flex sm:items-center sm:gap-7 lg:justify-center">
            <a className="transition hover:text-[#f2bd56]" href="#about">About</a>
            <a className="transition hover:text-[#f2bd56]" href="#platform">Platform</a>
            <a className="transition hover:text-[#f2bd56]" href="#services">Services</a>
            <a className="transition hover:text-[#f2bd56]" href="#contact">Contact</a>
          </nav>

          <div className="grid gap-3 text-sm text-[#d9e7f5] lg:justify-end">
            <p className="flex items-center gap-3">
              <Mail size={18} className="text-[#f2bd56]" />
              info@procesg.com
            </p>
            <p className="flex items-center gap-3">
              <Phone size={18} className="text-[#f2bd56]" />
              +91 22 4970 6423
            </p>
            <p className="flex items-center gap-3">
              <Globe2 size={18} className="text-[#f2bd56]" />
              India - APAC - Global
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 pt-6 text-xs text-[#b7c6d7] sm:flex-row sm:items-center sm:justify-between">
          <p>© 2024 ProceSG. All rights reserved.</p>
...
function SocialIcon({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <a
      className="grid size-9 place-items-center rounded-full border border-white/18 text-white/85 transition hover:border-[#f2bd56] hover:text-[#f2bd56]"
      href="#top"
      aria-label={label}
    >
      {children}
